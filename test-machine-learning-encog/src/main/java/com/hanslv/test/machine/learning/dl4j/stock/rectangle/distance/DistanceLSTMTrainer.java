package com.hanslv.test.machine.learning.dl4j.stock.rectangle.distance;
...
import com.hanslv.test.machine.learning.dl4j.stock.rectangle.RectangleLSTMBuilder;
...
public class DistanceLSTMTrainer {
	static int inputSize = 2;//输入神经元数量
	static int idealOutputSize = 1;//输出神经元数量
	static int hideLayerARight = 60;//隐藏层A权重
	static int hideLayerBRight = 30;//隐藏层B权重
	static int hideLayerCRight = 15;//隐藏层C权重
	...
	public static ForecastResult train(String stockId , String endDate) {
		...
		List<String> allDataList = DbUtil.getRectangleArea(stockId, stepLong , endDate , singleBatchSize , batchSize , true);
